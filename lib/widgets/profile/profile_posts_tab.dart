        ...
        if (isMyProfile)
          Positioned(
            ...
            child: Material(
              ...
              elevation: 3.0,
              child: InkWell(
                onTap: onEditPicture, // プロフィール画面の関数を呼び出す
        ...
        children: [
          Padding(
            padding: const EdgeInsets.symmetric(
                horizontal: 0.0, vertical: 20.0), // 横パディングを削除
            child: Row(
              children: [
                _buildAvatarWidget(context), // contextを渡す
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 0.0), // 横パディングを削除
            child: Container(
